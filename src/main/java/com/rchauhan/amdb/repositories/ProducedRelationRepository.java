...
public interface ProducedRelationRepository extends Neo4jRepository<ProducedRelation, Long> {
    ...
    @Query("MATCH (p:Person {id: $personID}), (t:Title {id: $titleID}) CREATE (p)-[y:PRODUCED]->(t) RETURN p, y, t")
    ProducedRelation createProducedRelation(UUID personID, UUID titleID);
}
